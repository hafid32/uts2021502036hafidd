...
if ($act == 'edit') {
    $url = base_url() . "index.php?page=kembali&act=update";
    if ($kode) {
    ...
    $url = base_url() . "index.php?page=kembali&act=save";
}
?>
    ...
    <div class="card-body">
        <form action="<?php echo $url; ?>" method="post">
            ...
            <div class="md-3">
                ...
                <a class="btn btn-danger btn-sm float-start" href="list_kembali.php">
